...
const SideBar = () => {
  ...
  return (
    <div className="fixed h-full md:w-64 p-5 shadow-md">
      <Image src={"/Coursify.svg"} width={120} height={120} alt="logo" className="cursor-pointer"/>
      <hr className="my-5 " />
      <div className="flex flex-col">
        ...
        <div className="absolute bottom-10 w-[80%] p-2 bg-white rounded-xl">
          ...
          <Button className="w-full mt-2 cursor-pointer hover:bg-purple-800 hover:text-white" onClick={()=>router.push('/dashboard/upgrade')}>Upgrade</Button>
